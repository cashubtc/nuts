...
For outputs on keysets with version byte `02` or later, every quote in the batch **MUST** be locked ([NUT-04](04.md#taproot-transactions-v3-keysets)); a batch containing an unlocked quote **MUST** be rejected.
