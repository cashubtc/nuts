...
- `B_0 ... B_(n-1)` are UTF-8 encoded hex strings of **all blinded messages** from the `outputs` array (regardless of amount splitting)
- `:` is the colon separator (UTF-8 `0x3A`)
