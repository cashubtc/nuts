...
A batch request with any output on a v3 keyset follows this section, and all its `outputs` **MUST** share that keyset ([NUT-04](04.md#taproot-transactions-v3-keysets)). Every quote in the batch **MUST** be locked; a batch containing an unlocked quote **MUST** be rejected.
