...
- For keysets with version byte `02`, `Y = hash_to_curve_G1(secret)` is a compressed BLS12-381 G1 point (48 bytes / 96 hex characters); see [Pairing-based BDHKE (BLS12-381)](00.md#pairing-based-bdhke-bls12-381).
