...
| 0x0b | taproot          | sub-TLV   | Taproot locking option (corresponds to `taproot` in JSON)                                         |
...
### Taproot Sub-TLV (Tag 0x0b)

The [NUT-18][18] `taproot` locking option is encoded as a nested TLV structure:
