...
This NUT extends the `NUT10Option` object from [NUT-18][18] with an optional `b` field to signal P2BK support.

### Extended NUT10Option schema
...
In this example:
- The receiver signals P2BK support with `"b": true` inside the `nut10` object
