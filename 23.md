...
Each invidivual look-up has $1 - \frac{1}{M}$ chance of being a *true positive*. We can consider a bulk test as $x$ independent look-ups, so the chance that at *all* of them are true positives is $(1 - \frac{1}{M})^x$.

Therefore, the chance of any one of them being a *false positive* (or equivalently, **not** all of them being *true positives*) is $1 - (1 - \frac{1}{M})^x$.
