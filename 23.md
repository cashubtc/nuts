...
Subscribe to mint quote state changes for bolt11 invoices.

- **`filters`**: Array of mint quote IDs
- **`NotificationPayload`**: `PostMintQuoteBolt11Response` as defined above

#### `bolt11_melt_quote`

Subscribe to melt quote state changes for bolt11 invoices.

- **`filters`**: Array of melt quote IDs
