...
- `p`: The hex representation of a 33-byte compressed public key for locking the ecash ([NUT-11][11])
...
The `r` tag specifies the [`NDEFRecordType`][ndefrecordtype] that must be used for the record. Currently, `"text"` is the only option.
