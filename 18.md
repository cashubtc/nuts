...
This NUT introduces a standardized format for payment requests that supply a sending wallet with the information necessary to make a payment to the receiver. Payment requests enable use-cases where a transaction is better initiated by the receiver (e.g. point of sale).
