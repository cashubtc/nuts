...
3. The payer computes the tree root and the tweaked secret `P = K + t*G` ([NUT-10](10.md#nutroot-secrets-v3-keysets)), swaps to an output with secret `P`, and sends the proof with spend info `E`, the transmitted tree, and `K`.
