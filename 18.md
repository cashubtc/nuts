...
The payer serializes the payload into a base-64 encoded TokenV4 ([NUT-00](00.md)) and constructs a [`NDEFMessage`][ndefmessage] consisting of one single [`NDEFRecord`][ndefrecord] containing the entire token.
