...
- Fee calculation: in AC-03 balance verification, the delta MUST equal the sum of per-input fees (see AC-03 §3.6). If fractional fees arise, Mints MUST define rounding (RECOMMENDED: floor to integer units); clients MUST match the Mint policy.
