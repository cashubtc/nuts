...
For keysets with version byte `02` or later, `Proof.secret` is a compressed secp256k1 public key encoded as 66 lowercase hex characters ([NUT-10 Nutroot secrets](10.md#nutroot-secrets-v3-keysets)), and `x` is its **decoded 33 bytes**.
