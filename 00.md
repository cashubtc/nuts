...
`si` carries what the next holder of a v3 keyset proof needs beyond the proof itself; its fields and rules are defined in [NUT-10's spend info](10.md#spend-info).
