...
- `G1` generator point of BLS12-381 G1 curve group of order `n` (where `Y`, `B_`, `C_`, `C` live); points come from `hash_to_curve_G1`.
- `G2` generator point of BLS12-381 G2 of order `n`
- `Fr` finite field of integers modulo the group order `n`; scalars live here.
