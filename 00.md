...
- `G1` generator point of BLS12-381 G1 curve group of order `r` (where `Y`, `B_`, `C_`, `C` live); points come from `hash_to_curve_G1`.
- `G2` generator point of BLS12-381 G2 of order `r`
- `Fr` finite field of integers modulo the group order `r`; scalars live here.
