...
_In the DLEQ proof below, `r` is selected randomly by Bob the mint and is not to be confused with 'r' the blinding factor created and used by Alice when she blinds and unblinds_
