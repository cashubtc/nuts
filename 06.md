...
- `contact` (deprecated) is an array of contact methods to reach the mint operator. A contact method consists of two fields. The first denotes the method (like "email"), the second the identifier (like "contact@me.com").
- `contact_info` is an array of contact methods to reach the mint operator.
