...
To minimize the risk of loss of funds due to network errors during critical operations such as minting, swapping, and melting, we introduce a caching mechanism for successful responses. This allows wallets to replay requests on cached endpoints and allows them to recover the desired state after a network interruption.
