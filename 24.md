...
- `nut10`: The required locking condition, as the legacy [`nut10` option](legacy/18.md); a transition measure for clients that predate v3
- `nutroot`: The required [nutroot locking condition](18.md#nutroot-locking-v3-keysets) (v3 keysets); NUT-18's rule for a request carrying both applies
